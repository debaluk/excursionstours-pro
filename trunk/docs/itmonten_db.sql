...
--
-- Host: localhost
-- Generation Time: May 23, 2012 at 12:51 AM
...
CREATE TABLE IF NOT EXISTS `book_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=362 ;
...
INSERT INTO `gallery` (`ID`, `name`, `path`, `title`, `preview_pic`, `pic_count`, `vid_count`, `posts_ID`) VALUES
(67, NULL, 'gallery-67-test', 'test', NULL, 1, NULL, NULL);
...
(7, 'SOHO Group - Montenegro', 'soho', '5c8438bef7c60cf62b4a0aee3b0becc4', 1, 6, 1277462460);
...
--
ALTER TABLE `gallery`
  ADD CONSTRAINT `fk_gallery_car1` FOREIGN KEY (`posts_ID`) REFERENCES `car` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
