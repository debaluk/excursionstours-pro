            ...
            <div id="content-top" style="min-height: 300px;">
                ...
                <div id="rent_div_" style="margin-left: 22px; margin-right: 0px;">
                    <p>
                        ...
                        <div class="booking_result" style="width: 600px; min-height: 60px;">
                            <table width="100%" cellpadding="0" cellspacing="0" class="finish-table">
                                ...
                                <tbody id="tablebody">
                                    <tr>                                         
                                        <td><?=$title?></td>
                                        <td style="text-align: center;">&euro;<?=number_format($total_price, 2, '.', '')?></td>
                                        <td style="text-align: center;">&euro;<?=number_format($total_price, 2, '.', '')?></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="text-align:center;"><b>Total:</b></td>
                                        <td style="text-align: center;"><b>&euro;<?=number_format($total_price, 2, '.', '')?></b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        referring to the number of registration: <b><?=$invoice_no;?></b> <br /><br /> 
